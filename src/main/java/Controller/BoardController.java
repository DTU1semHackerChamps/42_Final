...
public class BoardController {
    ...
    public static Tile[] boardTiles(BuildableTilePrices[] prices, Player currentPlayer, Player[] players, TileOwners owners, PropertyGroup[] propertyGroups){
        ...
        boardTiles[2] = new ChanceCardTile(currentPlayer, players);
        ...
        boardTiles[7] = new ChanceCardTile(currentPlayer, players);
        ...
        boardTiles[17] = new ChanceCardTile(currentPlayer, players);
        ...
        boardTiles[22] = new ChanceCardTile(currentPlayer, players);
        ...
        boardTiles[33] = new ChanceCardTile(currentPlayer, players);
        ...
        boardTiles[36] = new ChanceCardTile(currentPlayer, players);
